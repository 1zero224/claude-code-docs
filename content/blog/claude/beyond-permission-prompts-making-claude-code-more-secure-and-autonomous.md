...
To get started with these tools:
  - Run `claude --sandbox` and check out [our docs](https://docs.claude.com/en/docs/claude-code/sandboxing) on how to configure this sandbox.
  - Go to [claude.com/code](http://claude.ai/code) to try out Claude Code on the web.
‍
