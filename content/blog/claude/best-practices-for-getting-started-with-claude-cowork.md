...
A few examples of where the line falls:
        ...
        Sample question or task Use     What should I cover in our business review meeting? Chat   Read the last three months of meeting notes in this Google Drive folder and build me a QBR deck using our template. Claude Cowork   How do I VLOOKUP something? Chat   Go through my spreadsheets and change all the VLOOKUP to INDEX MATCH. Claude Cowork   Suggest a better title tag and meta description for this page. Chat   Use the new title tags and meta descriptions for these 30 pages from this sheet and update them using the CMS connector. Claude Cowork
