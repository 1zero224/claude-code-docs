...
The** **advisor tool** **is available now in beta natively on the Claude Platform. To get started:
  ...
  - Modify your [system prompt](https://platform.claude.com/docs/en/agents-and-tools/tool-use/advisor-tool#suggested-system-prompt-for-coding-tasks) based on your use case
